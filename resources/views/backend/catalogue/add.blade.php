                                                ...
                                                <div class="row">
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="form-label-title col-sm-2 mb-0">
                                                            Title</label>
                                                        <div class="col-sm-10">
                                                          <input name="catalogue_name" type="text" placeholder="Title" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input name="catalogue_image" type="file" class="file picimg" required>   <br>
                                                    ...
                                                    <div class="row">
                                                        <label class="col-sm-2 col-form-label form-label-title">Select Product Name</label>
                                                        <div class="col-sm-10">
                                                            <select id="productSelect" class="js-example-basic-single w-100" name="product_id[]" required multiple>
