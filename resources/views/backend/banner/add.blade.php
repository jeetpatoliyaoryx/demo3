                  ...
                  <div class="card-header-2">
                    ...
                    <form class="theme-form theme-form-2 mega-form" method="post" action="" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="mb-4 row align-items-center">
                          <label class="form-label-title col-sm-2 mb-0">Desktop Banner </label>
                          <div class="col-sm-10">
                            <input name="desktop_banner" type="file" class="file picimg" required>
                            {{-- <img id="bannerPreview" class="banner-preview" style="display:none;" /> --}}
                            <span class="pt-2 highlight-text">(<b>Important:-</b> Please upload an image with resolution
                              of exactly 1440×548 px.)</span>
                          </div>
                        </div>
                        <div class="mb-4 row align-items-center">
                          <label class="form-label-title col-sm-2 mb-0">Mobile Banner </label>
                          <div class="col-sm-10">
                            <input name="mobile_banner" type="file" class="file picimg" required>
                          </div>
                        </div>
