                                            ...
                                            <form class="theme-form theme-form-2 mega-form"  method="post" action="" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                     ...
                                                     <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input name="icon_name" type="file" class="file picimg">   
                                                            @if(!empty($getrecord->icon_name))
                                                            <img src="{{ $getrecord->getIconName() }}" style="height:100px;"><br>
                                                            @endif
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="form-label-title col-sm-2 mb-0">
                                                            Sub Title</label>
                                                        <div class="col-sm-10">
                                                          <input name="sub_title" type="text" placeholder="Sub Title" class="form-control" required value="{{ $getrecord->sub_title }}">
                                                        </div>
                                                    </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const inputs = document.querySelectorAll('input[type="file"][name^="icon_name"]');
