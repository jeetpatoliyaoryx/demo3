        ...
        <footer id="footer" class="footer   ">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="{{ url('/') }}">
                                            <img alt="" loading="lazy" width="127" height="24" decoding="async"
                                                data-nimg="1" style="color:transparent;"
                                                src="{{ $getHomeHeader->getLogo() }}" />
                                        </a>
                                    </div>
                                    ...
                                    <ul class="tf-social-icon   ">
                                        ...
                                        <li>
                                            <a href="{{ $getHomeFooter->facebook_link }}" target="_blank" class="social-facebook">
                                        ...
                                        <li>
                                            <a href="{{ $getHomeFooter->instagram_link }}" target="_blank" class="social-facebook">
                            ...
                            <div class="col-lg-4">
                                <div class="footer-menu">
                                    <div class="footer-col-block">
                                        ...
                                        <div class="footer-heading text-button footer-heading-mobile">{{ $getHomeFooter->infomation }}</div>
                                        @endif
                                        <div class="tf-collapse-content">
                                            <ul class="footer-menu-list">
                                                @if(!empty($getHomeFooter->home))
                                                <li class="text-caption-1">
                                                    <a class="footer-menu_item" href="{{ url('/') }}">{{ $getHomeFooter->home }}</a>
                                                </li>
                                                @endif
                                                @if(!empty($getHomeFooter->about_us))
                                                <li class="text-caption-1">
                                                    <a class="footer-menu_item" href="{{ url('about') }}">{{ $getHomeFooter->about_us }}</a>
                                                </li>
                                                @endif
                                                @if(!empty($getHomeFooter->contact_us))
                                                <li class="text-caption-1">
                                                    <a class="footer-menu_item" href="{{ url('contact') }}">{{ $getHomeFooter->contact_us }}</a>
                                                </li>
                                                @endif
                                    ...
                                    <div class="footer-col-block">
                                        ...
                                        <div class="footer-heading text-button footer-heading-mobile">{{ $getHomeFooter->customer_services }}
                                        </div>
                                        @endif
                                        <div class="tf-collapse-content">
                                            <ul class="footer-menu-list">
                                                ...
                                                <li class="text-caption-1">
                                                    <a href="{{ url('shipping-refund') }}" class="footer-menu_item">{{ $getHomeFooter->shipping_policy }}</a>
                                                </li>
                                                  @endif
                                                   @if(!empty($getHomeFooter->return_policy))
                                                <li class="text-caption-1">
                                                    <a href="{{ url('return-policy') }}" class="footer-menu_item">{{ $getHomeFooter->return_policy }}</a>
                                                </li>
                                                   @endif
                                                 @if(!empty($getHomeFooter->privacy))
                                                <li class="text-caption-1">
                                                    <a href="{{ url('privacy') }}" class="footer-menu_item">{{ $getHomeFooter->privacy }}</a>
                                                </li>
                                                   @endif
                                                 @if(!empty($getHomeFooter->terms))
                                                <li class="text-caption-1">
                                                    <a class="footer-menu_item" href="{{ url('terms') }}">{{ $getHomeFooter->terms }}</a>
                                                </li>
                                                   @endif
                            ...
                            <div class="col-lg-4">
                                <div class="footer-col-block">
                                    ...
                                    <div class="footer-heading text-button footer-heading-mobile">{{ $getHomeFooter->newletter }}</div>
                                    @endif
                                    <div class="tf-collapse-content">
                                         {{-- Message start --}}
                                        <div style="display: none; margin-top: 15px; color:rgb(52, 168, 83)" class="alert alert-success newsletter-signup-success" role="alert"></div>
         <div style="display: none; margin-top: 15px; color:rgb(52, 168, 83)" class="alert alert-danger newsletter-signup-error" role="alert"></div>
         ...
         {{-- Message end --}}
                                        ...
                                        <div class="footer-newsletter">
                                            ...
                                            <form class="form-newsletter subscribe-form ajax-submit" method="post" action="{{ url('email-subscribe') }}">
                                                {{ csrf_field() }}
                                                <div class="subscribe-content">
                                                    <fieldset class="email">
                                                        <input type="email" class="subscribe-email"
                                                            placeholder="Enter your e-mail" tabindex="0"
                                                            aria-required="true" name="email" required value="{{ old('email') }}"/>
                                                    </fieldset>
                                            ...
                                            <div class="tf-cart-checkbox">
                                                ...
                                                <label class="text-caption-1" for="footer-Form_agree">
                                                    ...
                                                    <!-- -->
                                                    @if(!empty($getHomeFooter->terms))
                                                    <a class="fw-6 link" href="{{ url('terms') }}">{{ $getHomeFooter->terms }}</a>
                                                    @endif
                                                    and
                                                    <!-- -->
                                                    @if(!empty($getHomeFooter->privacy))
                                                    <a class="fw-6 link" href="{{ url('privacy') }}">{{ $getHomeFooter->privacy }}</a>
                                                    .
                                                    @endif
                                                </label>
                                            </div>
                                ...
                                <div class="footer-bottom-wrap">
                                    ...
                                    <div class="tf-payment">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <img alt="" loading="lazy" width="98" height="64" decoding="async"
                                                    data-nimg="1" style="color:transparent"
         ...
         <div class="tf-toolbar-bottom">
            <div class="toolbar-item">
                <a href="{{ url('/') }}">
                   ...
                   <svg xmlns="http://www.w3.org/2000/svg" x="0px" class="icon" y="0px" width="20" height="20" viewBox="0 0 50 50">
