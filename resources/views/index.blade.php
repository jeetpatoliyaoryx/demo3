                    ...
                    @foreach($getBanner as $value)
                            <div class="swiper-slide">
                                <div class="wrap-slider">
                                    ...
                                    <img alt="{{ $value->title ?? 'banner' }}" 
                                         loading="lazy" width="1920" height="803"
                                         decoding="async" data-nimg="1" style="color:transparent"
                                         src="{{ $value->getBannerImage() }}" />
        ...
        <section class="flat-spacing-2 pb_0">
            <div class="container">
                ...
                <div class="flat-collection-circle wow fadeInUp" data-wow-delay="0.1s">
                              ...
                              @foreach($value->subcategory as $subcategory)
                               <div class="swiper-slide">
                                    <div class="collection-circle hover-img"><a class="img-style"
                                            ...
                                            <img data-src="{{ $subcategory->getCategoryImage() }}"
                                                alt="collection-img" loading="lazy" width="363" height="363"
                                        ...
                                        <div class="collection-content text-center">
                                            <div><a class="cls-title" href="">
                                                    <h6 class="text">  {{ $subcategory->name }}</h6><i class="icon icon-arrowUpRight"></i>
                                                </a></div>
                    ...
                    <div
                        class="d-flex d-lg-none sw-pagination-collection sw-dots type-circle justify-content-center spd54">
                    </div>
        ...
        <section class="flat-spacing-3">
            <div class="container">
                <div class="heading-section text-center">
                    <!-- Bootstrap Tabs -->
                    <ul class="tab-product nav nav-tabs justify-content-sm-center tab-product-v2" id="topPicksTabs" role="tablist">
                        <li class="nav-item nav-tab-item"><a class="nav-link active" id="bottoms-tab"
                                data-bs-toggle="tab" href="#bottoms">New Arrivals</a></li>
                        <li class="nav-item nav-tab-item"><a class="nav-link" id="onpieces-tab" data-bs-toggle="tab"
                                href="#onpieces">Best Seller</a></li>
                        <li class="nav-item nav-tab-item"><a class="nav-link" id="tops-tab" data-bs-toggle="tab"
                                href="#tops">On Sale</a></li>
                    </ul>
                </div>
        ...
        <section class="bg-surface flat-spacing-8 flat-countdown-banner-2"
            ...
            <div class="container">
                <div class="box-content">
                    ...
                    <div class="btn-banner"><a class="tf-btn btn-fill" href="{{ url('catalogue/' . base64_encode($getSurface->catalogue_id)) }}"><span class="text">{{ $getSurface->button_text }}</span><i class="icon icon-arrowUpRight"></i></a></div>
                    @elseif(!empty($getSurface->button_text) && !empty($getSurface->type_catalogue_category == 2))
                      <div class="btn-banner">
                        ...
                        @endphp
                        <a class="tf-btn btn-fill" href="{{ url('m/'.$category_d->slug) }}"><span class="text">{{ $getSurface->button_text }}</span><i class="icon icon-arrowUpRight"></i></a></div>
                    @endif
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="banner-left">
                            <div class="collection-position style-lg hover-img">
                                <a class="img-style">
                                    <img
                                        data-src="{{ url($getSpacing->getImage()) }}" alt="banner" loading="lazy"
                                        width="473" height="630" decoding="async" data-nimg="1" class="lazyload"
                                        style="color:transparent" src="{{ url($getSpacing->getImage()) }}" />
                                </a>
                                <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="collection-default hover-img wow fadeInUp" data-wow-delay="0s"><a
                                                class="img-style"><img data-src="{{ $getSpacing->getImage1() }}"
                                                    alt="banner-cls" loading="lazy" width="450" height="450"
                                                    decoding="async" data-nimg="1" class="lazyload"
                                                    style="color:transparent" src="{{ $getSpacing->getImage1() }}" /></a>
                                            <div class="content text-center">
                                                <h6 class="title">
                                                     @if(!empty($getSpacing->image_title) && !empty($getSpacing->type_catalogue_category_2 == 1))
                                                    <a class="link" href="{{ url('catalogue/' . base64_encode($getSpacing->catalogue_id_2)) }}">{{ $getSpacing->image_title }}</a>
                                        ...
                                        @endphp
                                          ...
                                          <a class="link" href="{{ url('m/'.$category_d_2->slug) }}">{{ $getSpacing->image_title }}</a>
                                      @endif
                                    ...
                                    <div class="swiper-slide">
                                        <div class="collection-default hover-img wow fadeInUp" data-wow-delay="0.1s"><a
                                                class="img-style"><img data-src="{{ $getSpacing->getImage2() }}"
                                                    alt="banner-cls" loading="lazy" width="450" height="450"
                                                    decoding="async" data-nimg="1" class="lazyload"
                                                    style="color:transparent" src="{{ $getSpacing->getImage2() }}" /></a>
                                            <div class="content text-center">
                                                <h6 class="title">

                                                                   @if(!empty($getSpacing->image_title_2) && !empty($getSpacing->type_catalogue_category_3 == 1))
                                                    <a class="link" href="{{ url('catalogue/' . base64_encode($getSpacing->catalogue_id_3)) }}">{{ $getSpacing->image_title_2 }}</a>
                                        ...
                                        @endphp
                                          ...
                                          <a class="link" href="{{ url('m/'.$category_d_3->slug) }}">{{ $getSpacing->image_title_2 }}</a>
                                      @endif
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item hover-img">
                                    <div class="img-style">
                                        <img alt="img-testimonial" loading="lazy" width="468" height="624"
                                            decoding="async" data-nimg="1" style="color:transparent"
                                            src="{{ $value->getImage() }}" />
                                    </div>
                                    <div class="content">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-item rounded-0 hover-overlay hover-img wow fadeInUp" data-wow-delay=".1s">
                            <div class="img-style">
                                <img alt="image-gallery" loading="lazy" width="640" height="640" decoding="async"
            ...
            <div class="modal-content">
                ...
                <div class="modal-bottom text-center">
                    ...
                    <form action="{{ url("subscribe_email") }}" method="post" class="form-newsletter-subscribe">
                      ...
                      {{ csrf_field() }}
                            <input type="email" name="email" id="subscribe-email" placeholder="Enter your e-mail" required=""
                                name="email" />
                                 @if(!empty($getSubscribe->button_text))
                            <button type="submit"
                                class="btn-style-2 radius-12 w-100 justify-content-center">
