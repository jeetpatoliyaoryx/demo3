  ...
  <table class="container" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td class="content">
        ...
        <p style="color: white;">Hi <strong>{{ $user->name }}</strong>,</p>
        <p style="color: white;">Thank you for registering at <strong>YourStore.in</strong>. Your account has been created successfully.</p>

        <div class="summary">
          <p><strong>Registered Email:</strong> {{ $user->email }}</p>
          <p><strong>Password:</strong> {{ $password }}</p>
          <p><strong>Registration Date:</strong> {{ now()->format('d M Y') }}</p>
        </div>

        <center>
          <a href="{{ url('/login') }}" class="btn" style="color: black;">Login to Your Account</a>
        </center>
